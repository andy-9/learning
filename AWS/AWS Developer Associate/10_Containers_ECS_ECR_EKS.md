...
- [Containers on AWS](#containers-on-aws)
  ...
  - [Amazon ECS – Fargate Launch Type](#amazon-ecs--fargate-launch-type)
    ...
    - [ECS Rolling Updates](#ecs-rolling-updates)
      - [ECS Rolling Update – Min 50%, Max 100%](#ecs-rolling-update--min-50%25-max-100%25)
      - [ECS Rolling Update – Min 100%, Max 150%](#ecs-rolling-update--min-100%25-max-150%25)
      - [ECS tasks invoked by Event Bridge](#ecs-tasks-invoked-by-event-bridge)
      - [ECS tasks invoked by Event Bridge Schedule](#ecs-tasks-invoked-by-event-bridge-schedule)
      - [ECS – SQS Queue Example](#ecs--sqs-queue-example)
      - [ECS – Intercept Stopped Tasks using EventBridge](#ecs--intercept-stopped-tasks-using-eventbridge)
    ...
    - [Amazon ECS - One IAM Role per Task Definition](#amazon-ecs---one-iam-role-per-task-definition)
    - [Amazon ECS – Environment Variables](#amazon-ecs--environment-variables)
    - [Amazon ECS – Data Volumes (Bind Mounts)](#amazon-ecs--data-volumes-bind-mounts)
    - [Amazon ECS – Task Placement](#amazon-ecs--task-placement)
      - [Amazon ECS – Task Placement Process](#amazon-ecs--task-placement-process)
      - [Amazon ECS – Task Placement Strategies](#amazon-ecs--task-placement-strategies)
      - [Amazon ECS – Task Placement Constraints](#amazon-ecs--task-placement-constraints)
  ...
  - [Amazon EKS Overview](#amazon-eks-overview)
    ...
    - [EKS – Data Volumes](#eks--data-volumes)
