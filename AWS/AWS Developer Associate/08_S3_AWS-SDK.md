...
- [S3](#s3)
  ...
  - [Examples](#examples)
    ...
    - [Advanced: Cross-Account Access – Use Bucket Policy](#advanced-cross-account-access--use-bucket-policy)
...
- [AWS CLI, SDK, IAM Roles & Policies](#aws-cli-sdk-iam-roles--policies)
  - [EC2 Instance Metadata (IMDS)](#ec2-instance-metadata-imds)
    - [IMDSv2 vs. IMDSv1](#imdsv2-vs-imdsv1)
  - [MFA with CLI](#mfa-with-cli)
  - [AWS SDK Overview](#aws-sdk-overview)
    - [AWS SDK Overview](#aws-sdk-overview-1)
...
- [S3 - Advanced](#s3---advanced)
  ...
  - [S3 – Baseline Performance](#s3--baseline-performance)
    - [Performance: Multi-Part upload](#performance-multi-part-upload)
    - [Performance: S3 Transfer Acceleration](#performance-s3-transfer-acceleration)
    - [Performance – S3 Byte-Range Fetches](#performance--s3-byte-range-fetches)
